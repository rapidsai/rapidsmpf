...
| `buffer-spilled-time` | How long the device memory a spill released stayed free, measured from the end of the copy that spilled the data to the start of the copy that unspilled it. Data that is never unspilled is not counted. |
