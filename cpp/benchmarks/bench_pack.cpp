...
/**
 * @brief Benchmark for cudf::chunked_pack with device memory, copying to host memory.
...
/**
 * @brief Benchmark for cudf::chunked_pack with pinned memory, copying to pinned host
 * memory.
 * @param state The benchmark state containing the table size in MB as the first range
 * argument.
 */
...
/**
 * @brief Benchmark for cudf::chunked_pack with pinned memory, copying to host memory.
 * @param state The benchmark state containing the table size in MB as the first range
 * argument.
 */
...
BENCHMARK(BM_Pack_pinned_copy_to_pinned_host)
    ->Apply(PackArguments)
    ->UseRealTime()
    ->Unit(benchmark::kMillisecond);
