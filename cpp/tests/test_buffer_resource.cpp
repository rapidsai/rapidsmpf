...
TEST(BufferResource, LimitAvailableMemory) {
    ...
    auto dev_buf1 = zeroes(br, 10_KiB, stream, reserve1);
    ...
    EXPECT_THROW(zeroes(br, 10_KiB, stream, reserve1), std::overflow_error);
    ...
    auto dev_buf2 = zeroes(br, 10_KiB, stream, reserve2);
