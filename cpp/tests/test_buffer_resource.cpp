...
TEST_P(PinnedMaxPoolSizeReservationLimitTest, TwoReservations) {
    ...
    auto br = BufferResource::create(
        Statistics::disabled(), cuda_mr, pinned_mr, std::move(memory_limits)
    );
