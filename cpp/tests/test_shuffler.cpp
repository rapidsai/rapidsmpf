...
class ShuffleInsertGroupedTest : public cudf::test::BaseFixtureWithParam<
                                     std::tuple<rapidsmpf::shuffler::PartID, size_t>> {
  public:
    void SetUp() override {
        pids = std::vector<rapidsmpf::shuffler::PartID>(std::get<0>(GetParam()));
