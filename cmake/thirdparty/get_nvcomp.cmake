...
function(find_and_configure_nvcomp)
  ...
  set(export_args)
  if(RAPIDSMPF_EXPORT_NVCOMP)
    set(export_args BUILD_EXPORT_SET rapidsmpf-exports INSTALL_EXPORT_SET rapidsmpf-exports)
  endif()
  rapids_cpm_nvcomp(${export_args} USE_PROPRIETARY_BINARY ON)

  # Per-thread default stream
  if(TARGET nvcomp AND RAPIDSMPF_USE_PER_THREAD_DEFAULT_STREAM)
